...
// github.com/terra-money/alliance v0.1.1-0.20230323101136-6bcb1723dec1
)
...
replace (
	github.com/CosmWasm/wasmd => github.com/CosmWasm/wasmd v0.31.1-0.20230320093222-7e936c7fffb6
