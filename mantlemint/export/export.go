...
func ExportAllAccounts(app *app.App) error {
...
func ExportCirculatingSupply(app *app.App) (sdktypes.Int, error) {
	...
	app.AuthKeeper.IterateAccounts(ctx, func(account authtypes.AccountI) (stop bool) {
		switch account.(type) {
...
func runAccountExportWorker(app *app.App) {
