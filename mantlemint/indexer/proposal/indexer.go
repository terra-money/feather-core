...
func proposalIndexerFunc(db safe_batch.SafeBatchDB, block *tm.Block, blockID *tm.BlockID, evc *mantlemint.EventCollector, a *app.App) (err error) {
	if err != nil {
		return err
	}
	err = indexNewBlock(db, a, evc, block)
	if err != nil {
		panic(err)
	}
	return nil
...
func indexNewBlock(db safe_batch.SafeBatchDB, _ *app.App, evc *mantlemint.EventCollector, block *tm.Block) (err error) {
