...
func (app *localClient) PrepareProposalAsync(proposal types.RequestPrepareProposal) *abcicli.ReqRes {
	//TODO implement me
	panic("implement me")
}

func (app *localClient) ProcessProposalAsync(proposal types.RequestProcessProposal) *abcicli.ReqRes {
	//TODO implement me
	panic("implement me")
}

func (app *localClient) PrepareProposalSync(proposal types.RequestPrepareProposal) (*types.ResponsePrepareProposal, error) {
	//TODO implement me
	panic("implement me")
}

func (app *localClient) ProcessProposalSync(proposal types.RequestProcessProposal) (*types.ResponseProcessProposal, error) {
	//TODO implement me
	panic("implement me")
}
