...
import (
	...
	mconfig "github.com/terra-money/feather-core/mantlemint/config"
	"github.com/terra-money/feather-core/mantlemint/export"
)
...
func StartRPC(
	...
	if mantlemintConfig.EnableExportModule {
		export.RegisterRESTRoutes(apiSrv.Router, a)
	}

	// register all default GET routers...
	a.RegisterAPIRoutes(apiSrv, cfg.API)
