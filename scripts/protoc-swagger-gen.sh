...
proto_dirs=$(find $cosmos_sdk_dir/proto $alliance_dir/proto $wasm_dir/proto  $ibc_dir/proto ./proto ./third_party/proto -path -prune -o -name '*.proto' -print0 | xargs -0 -n1 dirname | sort | uniq)
